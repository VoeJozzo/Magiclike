...
| vengeful_spirit | round 16; Spirit 2/2 flying, death-trigger destroy (life-transfer shape, like martyr_saint where C4 LOST). User: "2.x is better" → DECISIVE treatment pool win | keeper 2.04 / gen_04 (seed 1930841241) = treatment, NON-nominated (treatment nominated gen_05) → generation>self-selection; control's 1.04 / gen_04 (seed 1815193130) flagged high-quality | **treatment** (decisive pool; keeper 2.04) |
