...
// draws the STICKER by rarity weight via pickWeightedSticker (the same
// machinery normal reward offers use), then a target permanent uniformly
// among that sticker's eligible permanents.
//
...
{
  // A battlefield that unlocks every pool corner: a defender creature
  // (remove_keyword), a 2-generic-cost creature (cost_mod), and a real
  // land (add_type land-color + Innate).
