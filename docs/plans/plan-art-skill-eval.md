...
**Keeper art placed (html-proto `art.png`):** worldly_tutor (2.02/control), righteous_cavalry (2.04/control), vine_twister (1.02/treatment), vengeful_spirit (2.04/treatment), squire_of_oaths (2.06/control), awaken_the_vault (1.01/treatment), wind_dancer (1.06/control, soft), crusaders_charm (2.06/control), ember_anvil (1.02/treatment) — plus reassigned frames garruks_companion + sage_of_the_wilds. drain_life: no keeper (no art placed).
