...
**Tally (keepers):** treatment 2, control 4, no-keeper 3. Quality-noted frames: control 4 (iron_statue 1.03, llanowar_elves 2.10, mercurial_adept 2.01 + 2.03). n=9 cards so far. Composition finding (martyr_saint): the C4 treatment kept rendering the gain-life mechanic literally as a two-figure "she gives / he receives" transfer, which doesn't survive the 64×32 downscale; control's single-figure framing read cleaner. (Observation: control keeps winning blind best-vs-best; treatment's edge from serra/inferno isn't recurring.)
