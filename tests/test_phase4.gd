...
# Smoke test for triggered abilities end-to-end:
...
#
# Exercises event firing, listener matching (self_only flag, predicate
# gating), APNAP-ordered drain, trigger stack entries, and the boot-time
# predicate registry.
